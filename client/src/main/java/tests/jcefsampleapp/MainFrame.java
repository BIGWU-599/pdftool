...
//        getContentPane().add(address_, BorderLayout.NORTH);
        ...
        browerUI_.setBackground(Color.RED);
        if(browerUI_ instanceof JPanel){
//            new BorderLayout(10,5)
            System.out.println("JPanel========" + ((JPanel) browerUI_).getLayout());
            System.out.println("JPanel========" + ((BorderLayout)((JPanel) browerUI_).getLayout()).getVgap() + "," + ((BorderLayout)((JPanel) browerUI_).getLayout()).getVgap());
            System.out.println("JPanel========" + ((JPanel) browerUI_).getComponentCount());
//            ((JPanel) browerUI_).setBorder(new EmptyBorder(-5, 0, -5, 0));

        }
        getContentPane().add(browerUI_, BorderLayout.CENTER);
//        getContentPane().add(((JPanel) browerUI_).getComponent(1), BorderLayout.CENTER);
        pack();
        setSize(800, 600);
        setVisible(true);
    ...
    public static void main(String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
        ...
        new MainFrame("https://sfccn.com/", useOsr, false);
    }
}
