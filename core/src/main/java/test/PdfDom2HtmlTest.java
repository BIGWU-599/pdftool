 ...
 */
public class PdfDom2HtmlTest {
    public final Logger log = LogManager.getLogger(PdfDom2HtmlTest.class);
    public final String STYLE_STRING = "string";
    public final String STYLE_LINE = "line";
    public final String STYLE_IMAGE = "image";
...
//            System.out.println("rows====" + pdfDomTree.getRows());
            ...
            for(int page = 0; page < pageList.size(); page++){
                ...
                rows.forEach((key,list)->{
                    ...
                    list.forEach(column->{
                        if(!column.getType().equals(STYLE_IMAGE)){
            ...
            for(int page = 0; page < pageList2.size(); page++){
                ...
                for(int r = 0; r < rowList.size(); r++){
                    ...
                    for(int c = 0; c < row.size(); c++){
                        ...
                        if(column.get(0).toString().equals(STYLE_STRING)){
...
//        java.util.logging.Logger.getLogger("org.mabb.fontverter.opentype.TtfInstructions.TtfInstructionParser").setLevel(Level.WARNING);
        ...
        PdfDom2HtmlTest pdfReaderTest = new PdfDom2HtmlTest();
