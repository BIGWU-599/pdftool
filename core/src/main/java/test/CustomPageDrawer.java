...
//        File file = new File("D:\\project\\idea\\datasfc\\pdftool\\doc",
//                "甘肃省2021年第二批认定报备高新技术企业名单.pdf");
        File file = new File("D:\\project\\idea\\datasfc\\pdftool\\doc\\grid2.pdf");
    ...
    private static class MyPageDrawer extends PageDrawer
    {
        ...
        {
//            System.out.println("1 fillPath=====windingRule:" + windingRule);
            // bbox in user units
            ...
            System.out.println("2 fillPath=====getBounds:" + bbox.getBounds() + "," + getLinePath().toString());
            graphics.setClip(graphics.getDeviceConfiguration().getBounds());
