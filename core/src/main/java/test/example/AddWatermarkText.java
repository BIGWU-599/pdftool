...
public class AddWatermarkText
{
    ...
    {
        args = new String[]{
            "D:\\project\\idea\\datasfc\\pdftool\\doc\\grid2.pdf",
            "D:\\project\\idea\\datasfc\\pdftool\\doc\\grid2_hight.pdf",
            "系统挂牌"
        };
...
//                PDType0Font font = PDType0Font.load(doc, new File("C:\\Windows\\Fonts\\SIMSUNB.TTF"));
                PDType0Font font = PDType0Font.load(doc, new File("C:\\Users\\Administrator\\AppData\\Local\\Microsoft\\Windows\\Fonts\\SourceHanSerifCN-Regular.ttf"));
